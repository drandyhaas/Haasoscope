...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog "$QSYS_SIMDIR/altchip_id/altchip_id.v" -work uniqueid -cdslib ./cds_libs/uniqueid.cds.lib
  ncvlog "$QSYS_SIMDIR/uniqueid.v"                                                                
fi
